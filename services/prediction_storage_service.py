...
class PredictionStorageService:
    ...
    async def create_prediction_record(
        ...
        mapped_data = self._map_prediction_result(
            prediction_result, mapping_json or {})
        ...
        if class_name is not None and is_malicious_mapped is not None:
            ...
            is_malicious, normalized_class = map_prediction_class(
                ...
                if field_name in ['accuracy_score', 'recall_score', 'precision_score', 'f1_score']:
                    ...
                    if value is not None:
                        if isinstance(value, bool):
                            ...
                            mapped_data[field_name] = value.lower(
                            ) in ['true', '1', 'yes', 'malicious', 'phishing', 'spam', 'scam']
                        else:
