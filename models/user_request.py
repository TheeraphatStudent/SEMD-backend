...
class UserUpdateRequest(BaseModel):
    ...
    full_name: Optional[str] = Field(None, min_length=1, max_length=512, description="Full name")
    birthday: Optional[datetime] = Field(None, description="Birthday")
    profile_img_uri: Optional[str] = Field(None, description="Profile image URI")
...
class AdminCreateUserRequest(BaseModel):
    ...
    full_name: str = Field(..., min_length=1, max_length=512, description="Full name")
...
class AdminUpdateUserRequest(BaseModel):
    ...
    birthday: Optional[datetime] = Field(None, description="Birthday")
    profile_img_uri: Optional[str] = Field(None, description="Profile image URI")
    role: Optional[RoleType] = Field(None, description="User role (Master Admin only)")
